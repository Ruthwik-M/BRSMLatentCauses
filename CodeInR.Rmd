...
```{r}
t.test(exp1B.est.test.stingy.normalisedpostestimate, exp1B.est.test.generous.normalisedpostestimate, var=TRUE)
cohensD(exp1B.est.test.stingy.normalisedpostestimate, exp1B.est.test.generous.normalisedpostestimate)
```
